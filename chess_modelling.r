### Code to figure out factors affecting chess performance ###
...
# read in up late info
# Indicator for when did some computer work after 11pm
uplate <- read.csv("https://raw.githubusercontent.com/hugh-miller/hug_mi_plays_chess/main/uplate.csv")
...
# game outcomes to score (0=loss, 1 = win, 0.5=draw)
res_list <- data.frame(
